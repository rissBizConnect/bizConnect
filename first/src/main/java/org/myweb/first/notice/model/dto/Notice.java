...
public class Notice implements java.io.Serializable {
	...
	private java.sql.Date noticeDate;	//DATE
	...
	private int readCoun;			//READCOUNT	NUMBER
	...
	public Notice(int noticeNo, String noticeTitle, Date noticeDate, String noticeWriter, String noticeContent,
			String originalFilePath, String renameFilePath, String importance, Date impEndDate, int readCoun) {
		super();
		this.noticeNo = noticeNo;
		this.noticeTitle = noticeTitle;
		this.noticeDate = noticeDate;
	...
	public int getReadCoun() {
		return readCoun;
	}

	public void setReadCoun(int readCoun) {
		this.readCoun = readCoun;
	}
	...
	public String toString() {
		return "Notice [noticeNo=" + noticeNo + ", noticeTitle=" + noticeTitle + ", noticeDate=" + noticeDate
				...
				+ ", impEndDate=" + impEndDate + ", readCoun=" + readCoun + "]";
	}
