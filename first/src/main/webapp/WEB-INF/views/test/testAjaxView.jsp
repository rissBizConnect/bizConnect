...
<h2>7. ajax 로 파일 업로드 처리 (form 올 전송)</h2>
...
function uploadFile2(){
	//javascript 로 ajax 기술 사용해서 파일업로드용 form 전송처리
...
function fileDown2(){
	...
	if(window.XMLHttpRequest || "ActiveXObject" in window){
		...
		var _window = window.open(filedownURLm || filename);
