...
<body>
	<section id="board">
		...
		<button onclick="openSetting();">
			<img src="/bizconnect/resources/images/chatbot.png">
		</button>
		<button onclick="openSetting();"></button>
		<div id="setting">
					...
					<div id="conversation">
						<div class="chatbot-message">
							<p class="chatbot-text">
								사이트에 오신것을 환영합니다.!<br> <br>원하시는 질문을 말씀하세요
							</p>
						</div>
					</div>
					<form id="input-form">
 ...
 -->
	...
	<script src="/bizconnect/resources/js/chatbot.js"></script>
</body>
