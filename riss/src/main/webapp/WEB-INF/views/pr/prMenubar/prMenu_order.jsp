...
<body>
    <div class="wrapper">
        <!-- 사이드바 -->
        <div class="sidebar">
            <h3><span style="color: #ffffff">재고관리 </span>&nbsp; | 수주관리</h3>
        <ul>
    ...
    background-color: #343a40; padding: 10px; border-radius: 5px;">수주관리 ▸ 주문조회</h1>
        ...
        <table>
            ...
            <tfoot>
            	...
            	<tr>
            		<td><input type="checkbox" name="selecteOrder" value="${pro.getordertNo()}"></td>
                    <td>${ o.orderDiv }</td>
                    <td>${ o.orderCnt }</td>
                    <td>${ o.orderPay }</td>
