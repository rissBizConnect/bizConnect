  ...
  <div class="form-group">
	...
	<hr>
		...
		<div class="form-group dynamic-field" id="sizeInput" >
		  <label for="orderDetailDate">수주납기일</label>
		  <input type="text" id="orderDetailDate" name="orderDetailDate" value="${od.orderDetailDate }" required>
		</div>
			
		<!-- 중량 입력 필드 -->
		<div class="form-group dynamic-field" id="weightInput" >
		  <label for="orderDetailPayment">수주-결제유무</label>
