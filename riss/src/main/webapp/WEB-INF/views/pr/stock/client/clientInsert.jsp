  ...
  <h2>사업자 등록</h2>
	...
	<form action="clientInsert.do" method="post" enctype="multipart/form-data">
		...
		<div class="form-group dynamic-field" id="sizeInput" >
		  ...
		  <input type="text" id="BusinessNum" name="BusinessNum" required>
		</div>
		...
		<div class="form-group dynamic-field" id="sizeInput" >
		  ...
		  <input type="text" id="PersonCharge" name="PersonCharge" required>
		</div>
		...
		<div class="form-group dynamic-field" id="sizeInput" >
		  ...
		  <input type="text" id="ClientTel" name="ClientTel" required>
		</div>
		
		<div class="form-group dynamic-field" id="sizeInput" >
		  <label for="ClientAddr">거래처주소</label>
		  <input type="text" id="ClientAddr" name="ClientAddr" required>
		</div>
		...
		<div class="form-group dynamic-field" id="sizeInput" >
		  ...
		  <input type="text" id="ClientFax" name="ClientFax" required>
		</div>
		
		<div class="form-group dynamic-field" id="sizeInput" >
		  <label for="FileName">저장파일명</label>
		  <input type="text" id="FileName" name="FileName" required>
		</div>
		
		<div class="form-group dynamic-field" id="sizeInput" >
		  <label for="ModifiDate">수정일</label>
		  <input type="date" id="ModifiDate" name="ModifiDate" required>
		</div>
