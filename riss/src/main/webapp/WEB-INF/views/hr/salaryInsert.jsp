...
<form action="salaryInsert.do" method="post"><br>
    ...
    <div class="form-group">
      ...
      <input type="number" id="salaryIncomT" name="salaryIncomT" value="0" required>
    </div>
    
    <div class="form-group">
      <label for="salaryLocalT">지방세</label>
      <input type="number" id="salaryLocalT" name="salaryLocalT" value="0" required>
    </div>
    
    <div class="form-group">
      <label for="salaryNPS">국민연금</label>
      <input type="number" id="salaryNPS" name="salaryNPS" value="0" required>
    </div>
    
    <div class="form-group">
      <label for="salaryHI">건강보험</label>
      <input type="number" id="salaryHI" name="salaryHI" value="0" required>
    </div>
    
    <div class="form-group">
      <label for="salaryEL">고용보험</label>
      <input type="number" id="salaryEL" name="salaryEL" value="0" required>
    </div>
    
   	<div class="form-group">
      <label for="salaryWCI">산재보험</label>
      <input type="number" id="salaryWCI" name="salaryWCI" value="0" required>
    </div>
    
    <div class="form-group">
      <label for="salaryLTCI">장기요양</label>
      <input type="number" id="salaryLTCI" name="salaryLTCI" value="0" required>
    </div>
    
    <div class="form-group">
      <label for="salaryTotalD">공제총합</label>
      <input type="number" id="salaryTotalD" name="salaryTotalD" value="0" required>
    </div>
    
    <div class="form-group">
      <label for="salaryIncentive">추가수당</label>
      <input type="number" id="salaryIncentive" name="salaryIncentive" min="0" value="0" required>
    </div>
