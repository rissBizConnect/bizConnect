...
<body>
	...
	<form action="retEdit.do" method="GET">
		퇴직자번호 <input type="hidden" name="retNo" value="${retire.retNo}" /> 
		GID: <input type="text" name="gid" value="${retire.gid}" required /><br /> 
		회사코드: <input type="text" name="comCode" value="${retire.comCode}" required /><br /> 
		...
		총 근무일: <input type="text" name="retTotalDate"
			value="${retire.retTotalDate}" required /><br /> 
