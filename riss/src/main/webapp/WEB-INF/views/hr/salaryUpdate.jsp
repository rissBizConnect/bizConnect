...
<input type="hidden" id="salaryNo" name="salaryNo" value="${salary.salaryNo }">
    ...
    <div class="form-group">
      ...
      <input type="number" id="salaryIncomT" value="${salary.salaryIncomT }" name="salaryIncomT" required>
    </div>
    
    <div class="form-group">
      <label for="userRegNo">지방세</label>
      <input type="number" id="salaryLocalT" value="${salary.salaryLocalT }" name="salaryLocalT" required>
    </div>
    
    <div class="form-group">
      <label for="userPhone">국민연금</label>
      <input type="number" id="salaryNPS" value="${salary.salaryNPS }" name="salaryNPS" required>
    </div>
    
   	<div class="form-group">
      <label for="userEmail">건강보험</label>
      <input type="number" id="salaryHI" value="${salary.salaryHI }" name="salaryHI" required>
    </div>
    
    <div class="form-group">
      <label for="userAddr">고용보험</label>
      <input type="number" id="salaryEL" value="${salary.salaryEL }" name="salaryEL" required>
    </div>
    
    <div class="form-group">
      <label for="userEntry">산재보험</label>
      <input type="number" id="salaryWCI" value="${salary.salaryWCI }" name="salaryWCI" required>
    </div>
    
    <div class="form-group">
      <label for="userPay">장기요양</label>
      <input type="number" id="salaryLTCI" value="${salary.salaryLTCI }" name="salaryLTCI" min="0" required>
    </div>
    
    <div class="form-group">
      <label for="userAccount">공제총합</label>
      <input type="number" id="salaryTotalD" value="${salary.salaryTotalD }" name="salaryTotalD" required>
    </div>
    
    <div class="form-group">
      <label for="userCard">추가수당</label>
      <input type="number" id="salaryIncentive" value="${salary.salaryIncentive }" name="salaryIncentive" required>
    </div>
