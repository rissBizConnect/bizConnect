...
public class User implements java.io.Serializable {
    ...
    private String userJob;    // 직무 추가
    private String userPhone;  // 전화번호 추가
    private String userEmail;  // 이메일 추가
    private String userEntryDate; // 입사일 추가
    ...
    public User(String gID, String userPw, String comCode, String userName, String userRole, String userJob,
			String userPhone, String userEmail, String userEntryDate, String userCard, String userAddr) {
		super();
		this.gID = gID;
		this.userPw = userPw;
		this.comCode = comCode;
