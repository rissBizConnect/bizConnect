...
public class ContractsDAO {
	...
	// 증명서 목록 조회
    public List<Contracts> selectContracts() {
        return sqlSessionTemplate.selectList("contractsMapper.selectContracts");
    }

    // 증명서 상세 조회
    public Contracts selectContractsById(String contractsId) {
        return sqlSessionTemplate.selectOne("contractsMapper.selectContractsById", contractsId);
    }

    // 증명서 추가
    public int insertContracts(Contracts contracts) {
        return sqlSessionTemplate.insert("contractsMapper.insertContracts", contracts);
    }

    // 증명서 수정
    public int updateContracts(Contracts contracts) {
        return sqlSessionTemplate.update("contractsMapper.updateContracts", contracts);
    }
    
    // 증명서 삭제
	public int deleteContracts(String contractsId) {
		return sqlSessionTemplate.delete("contractsMapper.deleteContracts", contractsId);
	}
